...
import com.hospital.repository.DoctorService;
...
public class HospitalService {
    ...
    public static DoctorService doctorService = new DoctorService(doctorRepository,patientService);
...
//        slowPrint("\033[34m================ SAGLIGINIZ BIZIM ICIN ONEMLIDIR ==================\033[0m\n", 10);
        ...
        try {
            Connection con = HibernateUtils.con;//DriverManager.getConnection("jdbc:postgresql://localhost:5432/hospital_dev02","dev02","123456");
